...
/**
 * Default acoustic material presets
 *
 * These values are based on standard acoustic absorption coefficients
 * and can be overridden per-project via UAcousticProfileAsset.
 */
...
namespace AcousticDefaults
{
    ...
    FAcousticMaterial GetDefaultMaterial(EAcousticMaterialType Type)
    {
        ...
        switch (Type)
        {
            ...
            case EAcousticMaterialType::Glass:
                ...
                Material.Transmission = 0.3f;  // Partial transmission
                Material.Scattering = 0.02f;
                break;
            ...
            case EAcousticMaterialType::Foliage:
                ...
                Material.Transmission = 0.8f;  // High transmission
                Material.Scattering = 0.70f;  // Very diffuse
                break;
    ...
    FAcousticZonePreset GetDefaultZonePreset(EAcousticZoneType Type)
    {
        ...
        switch (Type)
        {
            ...
            case EAcousticZoneType::Hallway:
                ...
                Preset.EarlyReflectionLevel = 1.5f;  // Strong early reflections
            ...
            case EAcousticZoneType::Cave:
                ...
                Preset.RT60 = 3.0f;
                Preset.HFDecay = 0.6f;
                Preset.LFDecay = 1.2f;  // Bass builds up
                Preset.Density = 0.8f;
            ...
            case EAcousticZoneType::Cathedral:
                ...
                Preset.EarlyReflectionLevel = 0.8f;  // Fewer early reflections
                Preset.LateReverbLevel = 1.5f;      // Massive late reverb
            ...
            case EAcousticZoneType::Forest:
                ...
                Preset.LFDecay = 0.8f;
                Preset.Density = 0.2f;
                Preset.Diffusion = 0.9f;  // Very diffuse
            ...
            case EAcousticZoneType::Underwater:
                ...
                Preset.RT60 = 0.5f;
                Preset.HFDecay = 0.3f;  // Heavy HF absorption
                Preset.LFDecay = 1.5f;  // LF carries further
                Preset.Density = 0.9f;
